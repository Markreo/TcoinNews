        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <g:form name="category" controller="admin" action="update" id="${admin.id}" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Đổi mật khẩu<br></label>
                                <div class="col-sm-10">
                                    <div>
                                        <label> <input name="changePassword" ${changePassword ? 'checked' : ''} type="checkbox" onclick="$('#change').toggleClass('active')"></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="cpwrd ${changePassword ? 'active' : ''}" id="change">
